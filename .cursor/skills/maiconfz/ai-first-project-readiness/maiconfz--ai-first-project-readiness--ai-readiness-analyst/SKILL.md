---
name: maiconfz--ai-first-project-readiness--ai-readiness-analyst
description: >-
  Analyze architecture, docs, agents, skills, and tooling; report what helps or
  blocks AI-first work. Use when the user needs the
  maiconfz--ai-first-project-readiness--ai-readiness-analyst workflow.
---
# Overview
