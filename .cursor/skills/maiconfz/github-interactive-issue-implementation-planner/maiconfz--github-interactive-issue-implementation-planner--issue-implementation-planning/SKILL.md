---
name: >-
  maiconfz--github-interactive-issue-implementation-planner--issue-implementation-planning
description: >-
...
- `issue-reference` (string): Issue number or full GitHub issue URL.
- `repository` (string): Optional target repository as owner/name when not inferable.
- `user-clarifications` (string): Optional user answers accumulated across clarification loops.

### Outputs

- `refined-implementation-plan` (string): Final markdown implementation plan after refinement.
- `open-questions` (string): Markdown list of remaining questions after refinement.
...
- maiconfz--github-interactive-issue-implementation-planner--implementation-plan-refiner
