...
function useStickySearch(threshold: number): boolean {
...
function renderCatalogAlert(options: {
...
function renderCatalogLoadingSpinner(): ReactNode {
  return (
    <section
...
function renderEmptyCatalogState(hasCatalog: boolean): ReactNode {
  return (
        ...
        <Container>
          ...
          {showLoadingSpinner ? (
            ...
            <>
              ...
              {filteredPackages.length === 0 ? renderEmptyCatalogState(catalog !== null) : null}
            </>
          )}
        </Container>
      </section>
