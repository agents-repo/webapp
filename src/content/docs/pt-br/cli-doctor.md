...
- Antes de depurar `install` com falha, `agents:verify` no PR baseline ou `agents:ci` em pipelines personalizados (use `doctor --skip-artifact-download` para checagens no estilo verify)
