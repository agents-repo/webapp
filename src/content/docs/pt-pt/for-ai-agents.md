...
Após `npm run build:pages`, **`llms.txt` é a lista autoritativa** de cada URL `.md` de doc e pacote do site (o bloco estático abaixo é um snapshot; prefira obter `llms.txt`).
