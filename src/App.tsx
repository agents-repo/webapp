...
function App() {
  ...
  const searchControl = (
    <Form role="search" aria-label="Search packages">
      <InputGroup>
  ...
  return (
    <div className="app-shell">
      ...
      <main>
        <section className="py-5 border-bottom border-secondary-subtle app-hero">
          <Container>
        ...
        <section className="py-4 py-lg-5">
          <Container>
            <Row className="align-items-end mb-3">
              <Col>
                <h2 className="h3 mb-1">Recently updated packages</h2>
            ...
            <Row xs={1} md={2} xl={3} className="g-3 g-lg-4">
              {filteredPackages.map((pkg) => (
                <Col key={pkg.id}>
                  <Card bg="dark" text="light" className="h-100 border-secondary-subtle package-card">
                    <Card.Body className="d-flex flex-column gap-3">
                      <div>
                        ...
                        >
                          <h3 className="h5 mb-0 me-2">{pkg.name}</h3>
                          <Badge bg={pkg.status === 'active' ? 'success' : 'secondary'}>
                            {pkg.status}
                          </Badge>
                        </Stack>
                        <p className="small text-body-secondary mb-0">{pkg.description}</p>
                      </div>
