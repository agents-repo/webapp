...
- Thin layout wrappers that delegate to tested logic (`ThemeModeDropdown`)
- `Footer` as a thin layout wrapper; coverage is the a11y smoke test in
  `Footer.a11y.test.tsx`, not a unit test
