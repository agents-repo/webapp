...
![License](https://img.shields.io/github/license/agents-repo/webapp) ![PR baseline checks](https://github.com/agents-repo/webapp/actions/workflows/pr-baseline.yml/badge.svg?event=pull_request) [![Quality gate status](https://sonarcloud.io/api/project_badges/measure?project=agents-repo_webapp&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=agents-repo_webapp) ![Release](https://img.shields.io/github/v/release/agents-repo/webapp?sort=semver) ![Stars](https://img.shields.io/github/stars/agents-repo/webapp?style=flat) <!-- markdownlint-disable-line MD013 -->
