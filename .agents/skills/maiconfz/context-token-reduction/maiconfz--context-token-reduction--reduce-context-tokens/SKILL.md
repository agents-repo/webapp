---
name: maiconfz--context-token-reduction--reduce-context-tokens
description: >-
...
- `planning-consent` (boolean): Optional prior consent to run reduction planning.
...
- `reduction-plan` (string): Markdown plan; empty if the user declined planning.
- `open-questions` (string): Remaining blockers or follow-ups at handoff; copy from advisor blocking-questions when present.
