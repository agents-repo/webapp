---
name: maiconfz--context-token-reduction--token-footprint-analyst
description: >-
...
- `footprint-report` (string): Markdown footprint report with evidence-backed token-waste findings.
