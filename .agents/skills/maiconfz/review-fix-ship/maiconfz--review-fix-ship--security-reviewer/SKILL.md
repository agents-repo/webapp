---
name: maiconfz--review-fix-ship--security-reviewer
description: >-
  Security review of the scoped git diff. On Cursor launches the Security Review
  subagent; otherwise an equivalent in-package pass. No exploits or PoCs. Does
  not edit files.
---
# Overview
