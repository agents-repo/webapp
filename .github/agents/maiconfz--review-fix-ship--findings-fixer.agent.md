...
inputs:
  ...
  - name: dry-run
    type: boolean
    description: >-
      When true, triage, fix, and validate only — no commit or push. Defaults to
      false (full automation).
  - name: diff
    type: string
    description: >-
...
outputs:
  - name: triage-table
    type: string
    description: 'Markdown table with source, location, outcome, and rationale per finding.'
