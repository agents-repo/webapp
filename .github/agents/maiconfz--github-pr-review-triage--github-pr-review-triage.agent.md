---
name: maiconfz--github-pr-review-triage--github-pr-review-triage
description: >-
...
inputs:
  ...
  - name: dry-run
    type: boolean
    description: >-
      When true, fetch, triage, fix, and validate only — no commit, push, reply,
      resolve, or acknowledge. Defaults to false (full automation).
outputs:
  - name: triage-table
    type: string
    description: >-
