...
description: >-
  Inventory always-on rules, IDE instruction files, docs, skills, and
  tree shape that inflate agent context; report evidence-backed
...
outputs:
  - name: footprint-report
    type: string
    description: >-
      Markdown footprint report with evidence-backed token-waste
      findings.
---
