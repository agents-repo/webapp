---
name: maiconfz--ai-first-project-readiness--ai-first-project-planning
description: >-
...
license: MIT
agents:
  - maiconfz--ai-first-project-readiness--ai-readiness-analyst
  - maiconfz--ai-first-project-readiness--improvement-planner
inputs:
  - name: planning-consent
    type: boolean
    description: Optional prior consent to run improvement planning.
  - name: plan-mode
    type: string
    description: Optional plan shape; phased or full-shot when already known.
...
outputs:
  ...
  - name: open-questions
    type: string
    description: >-
      Remaining blockers or follow-ups at handoff; copy from planner
